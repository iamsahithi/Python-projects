...
path = ''
#############################################################  Labels
IntroLabel = Label(root,text='Corona Virus Info',font=('arial',30,'italic bold'),bg='white',width=22)
...
############################################################  Buttons
InHtml = Button(root,text='Html',bg='red',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='blue',activeforeground='white',
                bd=5,width=5,command=inhtml)
InHtml.place(x=210,y=150)

InJson = Button(root,text='Json',bg='red',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='blue',activeforeground='white',
                bd=5,width=5,command=injson)
InJson.place(x=320,y=150)

InCsv = Button(root,text='Csv',bg='red',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='blue',activeforeground='white',
                bd=5,width=5,command=incsv)
InCsv.place(x=430,y=150)

Submit = Button(root,text='Submit',bg='purple',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='blue',activeforeground='white',
